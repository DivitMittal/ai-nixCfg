...
├── config/home/           # personal configs: coding/ per tool, cli/, cloud.nix, mcp.nix, workflows.nix
...
- OpenClaw (`config/home/coding/assistants/openclaw/`) is a minimal tool with only `setup.nix`.
